...
global lambda deltaE deltaP sig eta gammaI alfaI gammaA zeta gammaH alfaH ...
    gammaQ betaP betaA betaI eff1 eff2 ef1 prima_d seconda_d ...
    Lvect teta
...
xdot = zeros(31,1);
    ...
    xdot(11) = gammaI*I + gammaA*A + gammaH*3*H3;
    xdot(12) = alfaI*I + alfaH*3*H3;
    ...
    xdot(16) = deltaE*2*E12 - deltaP*P1;
    ...
    xdot(23) = gammaI*I1 + gammaA*A1 + gammaH*3*H13;
    xdot(24) = (1-ef1)*alfaI*I1 + (1-ef1)*alfaH*3*H13;
    ...
    xdot(28) = deltaE*2*E22 - deltaP*P2;

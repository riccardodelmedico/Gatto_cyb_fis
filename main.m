...
%aggiorniamo il modello affinchè l'epidemia viaggi con tempo di raddoppio circa 3, settando qui R0=2.65
R0= 2.65;
r0_raddoppio; 
...
%cambiamo i parametri equivalenti di R0, poichè l'epidemia rallenta a causa delle nuove distribuzioni gamma
